...
export default function ShopPage() {
  ...
  return (
    <div className="min-h-screen bg-gray-50 pb-24">
      ...
      <div className="px-4 -mt-4 relative z-10 max-w-7xl mx-auto">
            ...
            {filteredProducts.map((product) => (
              ...
              >
                ...
                <div className="aspect-[4/3] bg-gradient-to-br from-gray-50 to-gray-100 relative overflow-hidden">
                  ...
                  {/* Botón de favorito */}
                  <button className="absolute top-2 right-2 p-1.5 bg-white/90 backdrop-blur-sm rounded-full hover:bg-white transition-colors">
                  ...
                  <button
                    ...
                    className="absolute bottom-2 right-2 p-1.5 bg-blue-600 text-white rounded-full hover:bg-blue-700 transition-colors shadow-lg"
                  >
      ...
      <div className="px-4 mt-8 mb-6 max-w-7xl mx-auto">
